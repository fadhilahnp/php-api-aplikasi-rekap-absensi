...
or exit('{"status":"Error","data":"","message":"Sinkronisasi data gagal"}');
...
for($a = 0; $a < count($buffer); $a++){
    ...
    // $check = "SELECT * FROM attendance WHERE pin='$pin' AND presence='$datetime' ";
    ...
    //     mysqli_query($koneksi, $sql) or exit(mysqli_error($koneksi));
    // }
